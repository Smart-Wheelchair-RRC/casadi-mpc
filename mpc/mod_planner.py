...
class MotionPlanner:
    ...
    def _get_optimization_variable_bounds(
        ...
        state_bounds_shape = (self.num_states, self.horizon + 1)
        states_lower_bounds = ca.repmat(-ca.inf, state_bounds_shape)
        states_upper_bounds = ca.repmat(ca.inf, state_bounds_shape)
        ...
        optimization_variable_lower_bounds = DM_vertcat(
            states_lower_bounds.reshape((-1, 1)), 
            lower_control_bounds.reshape((-1, 1))
        )
        optimization_variable_upper_bounds = DM_vertcat(
            states_upper_bounds.reshape((-1, 1)),
            upper_control_bounds.reshape((-1, 1))
        )
