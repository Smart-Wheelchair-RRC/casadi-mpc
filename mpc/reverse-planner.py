...
class MotionPlanner:
    def __init__(
        ...
        self.reverse_velocity_weight = ca.DM(200)
        ...
        # Slack variable for reverse velocity penalty
        self.symbolic_delta_matrix = create_symbolic_matrix(
        ...
        self.symbolic_optimization_variables = MX_vertcat(
            ...
            self.symbolic_delta_matrix.reshape((-1, 1)),
        )
    ...
    def _get_symbolic_costs(
        ...
        return (
            ...
            + self._get_symbolic_reverse_velocity_cost()
    ...
    def _get_optimization_variable_bounds(
        ...
        optimization_variable_lower_bounds = DM_vertcat(
            lower_lane_bounds.reshape((-1, 1)), lower_control_bounds.reshape((-1, 1)), ca.DM.zeros((self.horizon, 1)),
        )
        optimization_variable_upper_bounds = DM_vertcat(
            upper_lane_bounds.reshape((-1, 1)), upper_control_bounds.reshape((-1, 1)), ca.repmat(ca.inf, (self.horizon, 1),)
        )
    ...
    def _get_symbolic_constraints(
        ...
        symbolic_constraints = MX_vertcat(
            ...
            self._get_symbolic_reverse_velocity_contraints(
                current_linear_velocity
            ).reshape((-1, 1)),
        )
    ...
    def _get_constraints_bounds(
        ...
        reverse_vel_lower_bound = ca.DM.zeros((self.horizon, 1))
        reverse_vel_upper_bound = ca.repmat(ca.inf, (self.horizon, 1))
    ...
    def solve(
        ...
        delta_matrix = np.zeros((1, self.horizon))
